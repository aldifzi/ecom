        ...
        <div class="product">
            ...
            <div class="item">
                <div class="item-main">
                    ...
                    <small class="text-muted">Count: <?= $item['qty']; ?></small>
            ...
            <hr>
            <?php endforeach; ?>
            <a href="<?= base_url(); ?>cart/delete_cart" onclick="return confirm('Apakah Anda yakin akan mengosongkan Troli?')"><button class="btn btn-outline-dark">Empty the Cart</button></a>
            <?php }else{ ?>
                <div class="alert alert-warning">Upss. Trolley still empty. Let's go shopping first..</div>
                <br><br><br>
            <?php } ?>
        </div>
        <?php
        ...
        <div class="total shadow">
            ...
            <?php if($cart->num_rows() > 0){ ?>
                <a href="<?= base_url(); ?>payment">
                    <button class="btn btn-dark btn btn-block mt-2">Proceed to Payment</button>
                </a>
            <?php }else{ ?>
                <a href="<?= base_url(); ?>">
                    <button class="btn btn-dark btn btn-block mt-2">Shop</button>
                </a>
            <?php } ?>
        </div>
    </div>
